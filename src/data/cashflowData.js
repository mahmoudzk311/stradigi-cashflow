...
// Source: Monthly_Cash_Flow_Comparison_6.xlsx (latest)
...
export const MONTHLY_EXPENSES = [
  ...
  { cogs:{a:83915.60,b:104894.50}, salaries:{a:93863.77,b:117329.71}, travel:{a:52706.59,b:65883.24},
    ...
    services:{a:21507.50,b:26884.38}, taxPaid:{a:0,b:0}, telephoneBill:{a:966.56,b:1208.20},
...
export const AR_AGING = [
  ...
  { inv:"INV-SD-000081", customer:"AECOM ME - Greenwood",                     date:"2025-10-02", dueDate:"2025-11-01", age:425, balance:140994.00,  amount:140994.00,  currency:"AED" },
  { inv:"—",             customer:"AECOM ME - Haffar Open Space",             date:"—",          dueDate:"—",          age:null,balance:381150.00,  amount:381150.00,  currency:"AED" },
  { inv:"—",             customer:"AECOM ME - Haffar Streetscape",            date:"2026-04-01", dueDate:"—",          age:null,balance:806400.00,  amount:804000.00,  currency:"AED" },
  { inv:"INV-SD-000082", customer:"AECOM ME - Greenwood",                     date:"2025-10-02", dueDate:"2025-11-01", age:425, balance:35249.00,   amount:35249.00,   currency:"AED" },
  ...
  { inv:"DCT-PME",       customer:"DCT - PME",                                date:"2026-03-01", dueDate:"—",          age:null,balance:84000.00,   amount:84000.00,   currency:"AED" },
  { inv:"DCT-TPC-03",    customer:"DCT - TPC",                                date:"2026-03-01", dueDate:"—",          age:null,balance:57000.00,   amount:57000.00,   currency:"AED" },
  { inv:"DCT-TPC-02",    customer:"DCT - TPC",                                date:"2026-02-01", dueDate:"—",          age:null,balance:57000.00,   amount:57000.00,   currency:"AED" },
  { inv:"DCT-TPC-01",    customer:"DCT - TPC",                                date:"2026-01-01", dueDate:"—",          age:null,balance:57000.00,   amount:57000.00,   currency:"AED" },
];

// ── AP Aging — 14 bills (updated) ─────────────────────────────────────────────
export const AP_AGING = [
  { inv:"—",      vendor:"One Palace",           date:"2026-04-12", dueDate:"—",          age:null, balance:3400.00,    amount:3400.00,    currency:"AED", status:"current" },
  { inv:"—",      vendor:"Mindset",              date:"2026-03-01", dueDate:"—",          age:null, balance:21787.78,   amount:21787.78,   currency:"AED", status:"current" },
  { inv:"—",      vendor:"Jawad",                date:"2026-02-01", dueDate:"—",          age:null, balance:4600.00,    amount:4600.00,    currency:"AED", status:"current" },
  { inv:"—",      vendor:"Project Advisor",      date:"2026-03-01", dueDate:"—",          age:null, balance:22400.00,   amount:22400.00,   currency:"AED", status:"current" },
  { inv:"—",      vendor:"IBIMS",                date:"2026-04-01", dueDate:"—",          age:null, balance:39500.00,   amount:39500.00,   currency:"AED", status:"current" },
  { inv:"—",      vendor:"Techture",             date:"2026-01-01", dueDate:"—",          age:null, balance:212500.00,  amount:212500.00,  currency:"AED", status:"current" },
  { inv:"—",      vendor:"Techture",             date:"2025-12-01", dueDate:"—",          age:null, balance:311000.00,  amount:311000.00,  currency:"AED", status:"current" },
  { inv:"—",      vendor:"WiiGroup",             date:"2026-02-01", dueDate:"—",          age:null, balance:24279.75,   amount:24279.75,   currency:"AED", status:"current" },
  { inv:"—",      vendor:"WiiGroup",             date:"2026-01-01", dueDate:"—",          age:null, balance:24279.75,   amount:24279.75,   currency:"AED", status:"current" },
  { inv:"—",      vendor:"WiiGroup",             date:"2025-12-01", dueDate:"—",          age:null, balance:24279.75,   amount:24279.75,   currency:"AED", status:"current" },
  { inv:"004",    vendor:"WiiGroup",             date:"2026-03-01", dueDate:"2025-04-25", age:250,  balance:24279.75,   amount:99850.68,   currency:"AED", status:"overdue" },
